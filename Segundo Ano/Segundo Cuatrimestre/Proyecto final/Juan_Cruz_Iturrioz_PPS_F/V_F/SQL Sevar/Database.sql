...
Jornada_laboral_inicio time(0) not null,
Jornada_laboral_fin time(0) not null,
...
Origen varchar (5) not null FOREIGN KEY REFERENCES Boleteria(Estacion),
Destino varchar (5) not null FOREIGN KEY REFERENCES Boleteria(Estacion),
